...
نظام بسيط للاستعلام عن بيانات الطالب (الصف والشعبة) عبر إدخال الاسم الكامل فقط.
...
- `data.js` — بصمات مشفرة للأسماء مع الصفوف والشعب، دون أسماء مكشوفة
...
- لا يحتوي `data.js` على أسماء الطلاب؛ بل على بصمات SHA-256 للأسماء الكاملة.
- يجب إدخال الاسم كاملًا كما يظهر في القائمة الرسمية، ولا يقبل النظام الاسم الجزئي.
